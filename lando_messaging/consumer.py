# -*- coding: utf-8 -*-
# patterned after from http://pika.readthedocs.io/en/0.11.2/examples/asynchronous_consumer_example.html
...
class AsyncQueueConsumer(object):
    ...
    """
    def __init__(self, host, username, password, queue_name, message_consumer_func):
        ...
        self._message_consumer_func = message_consumer_func
    ...
    def connect(self):
        ...
        connection_params = pika.ConnectionParameters(host=self._host,
                                                      ...
                                                      #heartbeat_interval=0 do I still need this
                                                      )
    ...
    def setup_queue(self):
        ...
        self._channel.queue_declare(self.start_consuming, self._queue_name, durable=True)

    def start_consuming(self, method_frame):
    ...
    def on_message(self, channel, basic_deliver, properties, body):
        ...
        self._message_consumer_func(channel, basic_deliver, properties, body)
